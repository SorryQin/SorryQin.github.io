...
<head>
  ...
  <title>Publications - Sorry Qin</title>
...
.content-section strong { color: var(--primary); }
...
<main class="main">
  <div class="content-section">
    <h2>Degree Thesis</h2>
    <p>Research on Zero-Shot Image Recognition Algorithm Based on Visual Semantic Attention Mechanism</p>
    <p><strong>Zuorui Qin</strong> (Advisor: Xinge You)</p>
  </div>
</main>
